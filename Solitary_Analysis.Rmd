...
12th Dec - Mac shut down unexpectedly and I lost the project environment. I do not want to run this again for an hour so I will populate the object with the results from the last run.

```{r}
#boot.sol.results <- read.table("output/Sol_BootStrapResults.tsv", header = T)
#boot.sol.results
```

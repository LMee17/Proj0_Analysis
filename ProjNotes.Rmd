...
```{r}
source("dataRead_immunity.R", local = knitr::knit_global())
```
...
```{r}
source("SigTests.R", local = knitr::knit_global())
```
...
```{r}
source("dataReadandTest_random.R", local = knitr::knit_global())
```
...
```{r}
source("pFisher.R", local = knitr::knit_global())
```
...
```{r}
source("adjFisher.R", local = knitr::knit_global())
```
...
```{r}
source("adjChi.R", local = knitr::knit_global())
```

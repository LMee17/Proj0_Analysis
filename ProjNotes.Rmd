...
The script has been written so that 100,000 iterations x social origin x class of gene (canon / noncanon) iterations will take place, with results being stored in bootstrap.results. Off to make a cup of tea.

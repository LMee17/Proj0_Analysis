...
#data is stored.
setwd("~/Documents/Projects/ProjectZero/Proj0_Analysis/input/solitary/immunity")
...
data.sol <- lapply(data.sol, function(x) merge(x, imm.verse.slim, by.x="Gene", by.y="GeneID"))

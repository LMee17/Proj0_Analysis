...
can.sol.2.results <- lapply(X=data.sol, y=100000, FUN = can.assess)
can.sol.2.results <- bind_rows(can.sol.2.results)
...
non.sol.2.results <- lapply(X=data.sol, y=100000, FUN = non.assess)
non.sol.2.results <- bind_rows(non.sol.2.results)

#Create one table
boot.sol.2.results <- rbind(can.sol.2.results, non.sol.2.results)
boot.sol.2.results
